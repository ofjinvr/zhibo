        ...
        <div class="container">
            <div class="containerL">
                ...
                <div class="category category3">
                    <ul>
                        <h3>按单位</h3>
                        <li class="<?php if(empty($_GET['cityname'])){echo 'active';}?>" style="width:42px;"><a href="?<?php if(!empty($_GET['typename'])){echo "&typename={$_GET['typename']}";}?><?php if(!empty($_GET['rolename'])){echo "&rolename={$_GET['rolename']}";}?>" >全部</a></li>
...
<!--                        <li class="--><?php //if(!empty($_GET['cityname']) and $_GET['cityname']==='西安国税'){echo 'active';}?><!--"><a href="?cityname=西安国税--><?php //if(!empty($_GET['typename'])){echo "&typename={$_GET['typename']}";}?><!----><?php //if(!empty($_GET['rolename'])){echo "&rolename={$_GET['rolename']}";}?><!--">西安国税</a></li>-->
...
<!--                        <li class="--><?php //if(!empty($_GET['cityname']) and $_GET['cityname']==='榆林国税'){echo 'active';}?><!--"><a href="?cityname=榆林国税--><?php //if(!empty($_GET['typename'])){echo "&typename={$_GET['typename']}";}?><!----><?php //if(!empty($_GET['rolename'])){echo "&rolename={$_GET['rolename']}";}?><!--">榆林国税</a></li>-->
                        <li class="<?php if(!empty($_GET['cityname']) and $_GET['cityname']==='方欣科技有限公司'){echo 'active';}?>"><a href="?cityname=方欣科技有限公司<?php if(!empty($_GET['typename'])){echo "&typename={$_GET['typename']}";}?><?php if(!empty($_GET['rolename'])){echo "&rolename={$_GET['rolename']}";}?>">方欣科技有限公司</a></li>
                        <li class="<?php if(!empty($_GET['cityname']) and $_GET['cityname']==='陕西航天信息有限公司'){echo 'active';}?>"><a href="?cityname=陕西航天信息有限公司<?php if(!empty($_GET['typename'])){echo "&typename={$_GET['typename']}";}?><?php if(!empty($_GET['rolename'])){echo "&rolename={$_GET['rolename']}";}?>">陕西航天信息有限公司</a></li>
                        <li class="<?php if(!empty($_GET['cityname']) and $_GET['cityname']==='陕西百旺金赋信息科技有限公司'){echo 'active';}?>"><a href="?cityname=陕西百旺金赋信息科技有限公司<?php if(!empty($_GET['typename'])){echo "&typename={$_GET['typename']}";}?><?php if(!empty($_GET['rolename'])){echo "&rolename={$_GET['rolename']}";}?>">陕西百旺金赋信息科技有限公司</a></li>
                    </ul>
                </div>
            </div>
