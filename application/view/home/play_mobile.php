...
<head>
    ...
    <script type="text/javascript" src="<?php echo base_url('resource/home')?>/js/clappr.js"></script>
    <style>
...
<body>
    ...
    <div class='video'>
        <div id="play" style="width: 100%; height: 270px; box-sizing: border-box; "></div>
        <script>
            new Clappr.Player({
    ...
    <div class='chatroom'>
        <div class='chatroom_head'>
            <span class='hudong' style="border-left:1px solid #fff">互动咨询</span>
