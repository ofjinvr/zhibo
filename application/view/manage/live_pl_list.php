        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="t_center"><?php echo $row['score'];?></td>
                    <td class="t_center"><?php echo $row['content'];?></td>
                    <td class="t_center"><?php echo date('Y-m-d H:i:s',$row['pubtime']);?></td>
                    <td class="t_center"><?php echo $row['is_checked'] ? '已审核' : '未审核';?></td>
                    <td class="t_center">
                        <a href="<?php echo site_url('manage/applications/live/pl_check/'.$row['id'])?>">通过审核</a> |
                        <a href="<?php echo site_url('manage/applications/live/pl_remove/'.$row['id'])?>">删除</a>
                    </td>
                </tr>
                <?php endforeach;?>
                <?php else:?>
