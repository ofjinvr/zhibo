...
class Video extends Fetch
{
    ...
    public function index(){
        ...
        $this->load->view('manage/video_list',$data);
    }
    ...
    public function add($action=null){
        if($action==='submit'){
            ...
            if($this->public_model->add($this->tb,$post)===false){
                ...
                skip_true('发布成功',site_url('manage/applications/video'));
            }
        }
    ...
    public function edit($id=null,$action=null){
        ...
        if($action==='submit'){
            ...
            if($this->public_model->edit($this->tb,$post,"id='$id'")===false){
                ...
                skip_true('编辑成功',site_url('manage/applications/video'));
            }
        }
