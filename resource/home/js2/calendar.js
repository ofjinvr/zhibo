...
Calendar.prototype.create = function (_par) {
    ...
    if (! _par) {
        ...
        // a popup calendar.
        parent = document.getElementById("date_box");
        this.isPopup = true;
    } else {
        parent = _par;
        this.isPopup = false;
...
//	(this.weekNumbers) && ++title_length;
    ...
    this._nav_py = hh("<img id=objyprev src=\"/resource/home/images2/yprev.gif\">", 1, -2);
...
//	this._nav_py = hh("&#x00ab;", 1, -2);
    ...
    //	this._nav_ny = hh("&#x00bb;", 1, 2);
    this._nav_ny = hh("<img id=objynext src=\"/resource/home/images2/ynext.gif\">", 1, 2);
    this._nav_ny.width = 25;
    this._nav_ny.ttip = Calendar._TT["NEXT_YEAR"];

//	this._nav_pm = hh("&#x2039;", 1, -1);
    this._nav_pm = hh("<img id=objmprev src=\"/resource/home/images2/mprev.gif\">", 1, -1);
...
//	this._nav_nm = hh("&#x203a;", 1, 1);
    this._nav_nm = hh("<img id=objmnext src=\"/resource/home/images2/mnext.gif\">", 1, 1);
...
//	this._nav_now.ttip = Calendar._TT["GO_TODAY"];
    ...
    if (this.isPopup) {
        ...
        var td_close = hh("<img id=objclose src=\"/resource/home/images2/close.gif\">", 1, 200);
...
Calendar.prototype.callHandler = function () {
    if (this.onSelected) {
        ...
        this.ssss(this.date.print(this.dateFormat));
        console.log(this.date.print(this.dateFormat));

        // window.location.href = '?date='+this.date.print(this.dateFormat);

    }
};
Calendar.prototype.ssss=function(params) {

    window.location.href = '?date='+params;
};
