...
/**
 * 用法举例:
 *  $rc = array('491434308@qq.com','1048999062@qq.com');
    $cc = array('travelphp@163.com','zxzx19900109@aliyun.com');
    $bcc= array('zxzx19900109@163.com');
    $title = '密码找回';
    $content = '密码找回,你的验证码是:123456';
    $test = $this->email->envelope($rc,$cc,$bcc)
                ->subject($title)
...
class Email{
    ...
    /*相关属性*/
    protected $rcpt;          //接收者并集,用于设置RCPT
    protected $handle;        //socket连接句柄
    protected $request;       //请求命令行
    protected $errno;         //错误号
    protected $errstr;        //错误描述
    ...
    public function send(){
        ...
        //连接服务器发送邮件
        if(!($this->handle=fsockopen($this->smtp,$this->port,$this->errno,$this->errstr,$this->socket_timeout))){
...
//            echo $value."\r\n";
            ...
            //SMTP服务器返回状态
            $result = fread($this->handle,10000);
//            echo $result."\r\n";
